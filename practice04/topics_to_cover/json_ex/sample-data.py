...
try:
    ...
    for item in interfaces:
        ...
        print(f"ID: {attrs['id']}, Admin State: {attrs['adminSt']}, Switching State: {attrs['switchingSt']}")

    enabled_ports = [
        item["l1PhysIf"]["attributes"]["id"]
        for item in interfaces
        if item["l1PhysIf"]["attributes"]["switchingSt"] == "enabled"
    ]

    print("\nEnabled Switching Ports:")
    for port in enabled_ports:
        print(port)

    disabled_count = sum(
        1 for item in interfaces
        if item["l1PhysIf"]["attributes"]["switchingSt"] == "disabled"
    )

    print("\nNumber of Disabled Ports:", disabled_count)

except FileNotFoundError:
    print("Error: The file 'sample_data.json' was not found.")
